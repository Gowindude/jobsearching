...
Companies discovered via web search not in the original target list.
...
| SoloPulse | Radar DSP Intern/Co-Op | Peachtree Corners, GA | Rolling | [Apply](https://jobs.lever.co/solopulseco/663eecca-0951-4354-9a0f-14b52aa72ab9) |
| SoloPulse | Systems Engineering Intern | Peachtree Corners, GA | Rolling | [Apply](https://jobs.lever.co/solopulseco/418b3949-3b21-48f9-b7a0-1c036ca0ba51) |

---

## ⚠️ Manual Check Required (Workday / JS-rendered)
These companies use Workday or other JS-rendered ATS pages that can't be
verified programmatically. Check their careers pages directly.

| Company | Careers Page | Category |
|---------|-------------|----------|
| Boeing | https://jobs.boeing.com | Space / Primes |
| Lockheed Martin | https://www.lockheedmartinjobs.com | Space / Primes |
| Northrop Grumman | https://www.northropgrumman.com/careers | Space / Primes |
| RTX / Raytheon | https://careers.rtx.com | Primes / Propulsion / Defense |
| Collins Aerospace (RTX) | https://careers.rtx.com | Primes / Avionics |
| Pratt & Whitney (RTX) | https://careers.rtx.com | Propulsion |
| General Dynamics | https://www.gd.com/careers | Primes / Defense |
| BAE Systems | https://jobs.baesystems.com | Defense / Primes |
| Honeywell Aerospace | https://careers.honeywell.com | Primes / Avionics |
| GE Aerospace | https://jobs.gecareers.com | Propulsion / Primes |
| Booz Allen Hamilton | https://careers.boozallen.com | Defense / Consulting |
| L3Harris | https://careers.l3harris.com | Defense / Propulsion (TalentBrew ATS) |
| Leidos | https://careers.leidos.com | Defense |
| SAIC | https://jobs.saic.com | Defense |
| Teledyne FLIR | https://www.teledyne.com/en-us/careers | Defense / Counter-UAS |
| AeroVironment | https://avav.wd1.myworkdayjobs.com/AVAV | Defense / UAS |
| Draper Laboratory | https://www.draper.com/careers | GNC / Flight Software |
| Garmin Aviation | https://careers.garmin.com | GNC / Avionics |
| Ansys | https://www.ansys.com/careers | CFD / Simulation |
| Siemens (Simcenter) | https://jobs.siemens.com | CFD / Simulation |
| Cadence | https://www.cadence.com/en_US/home/careers.html | EDA / Simulation |
| NASA | https://intern.nasa.gov | Research |
| AFRL Scholars | https://afrlscholars.usra.edu | Research |
| Sandia National Labs | https://www.sandia.gov/careers | Research |
| Oak Ridge National Lab | https://www.ornl.gov/careers | Research |

**Companies with unknown ATS (Greenhouse/Lever slugs all 404'd — check websites directly):**

| Company | Website | Category |
|---------|---------|----------|
| Blue Origin | https://www.blueorigin.com/careers | Space / Launch |
| Sierra Space | https://sierraspace.com/careers | Space |
| Firefly Aerospace | https://firefly.com/careers | Space / Launch |
| Apex Space | https://www.apexspace.com/careers | Space |
| Starfish Space | https://www.starfishspace.com/careers | Space |
| Turion Space | https://www.turionspace.com/careers | Space |
| Virgin Galactic | https://virgingalactic.com/careers | Space |
| United Launch Alliance | https://www.ulalaunch.com/careers | Space / Launch |
| ABL Space Systems | https://ablspacesystems.com/careers | Space / Launch |
| Anduril | https://www.anduril.com/careers | Defense (use Greenhouse: `andurilindustries`) |
| Skydio | https://www.skydio.com/careers | Autonomy / Defense (uses Ashby ATS) |
| Joby Aviation | https://www.jobyaviation.com/careers | eVTOL (uses iCIMS) |
| Archer Aviation | https://www.archer.com/careers | eVTOL (JS-rendered SPA) |
| Wisk Aero | https://wisk.aero/careers | eVTOL (uses Workday) |
| Fortem Technologies | https://fortemtech.com/careers | Counter-UAS |
| D-Fend Solutions | https://www.d-fendsolutions.com/careers | Counter-UAS |
| AeroDefense | https://www.aerodefense.net/careers | Counter-UAS |
| Kratos Defense | https://www.kratosdefense.com/careers | Defense |
| Textron Aviation | https://textron.taleo.net | Aeronautics |
| Cirrus Aircraft | https://www.cirrusaircraft.com/careers | Aeronautics |
| Aerojet Rocketdyne (L3Harris) | https://careers.l3harris.com | Propulsion |
| Firehawk Aerospace | https://www.firehawk-aerospace.com/careers | Propulsion |
| Venus Aerospace | https://www.venusaero.com/careers | Propulsion |
| Sarcos Technology | https://www.sarcos.com/careers | Autonomy |
| Reliable Robotics | https://www.reliable.aero/careers | Autonomy |
| Xwing | https://xwing.com/careers | Autonomy |
| Luminary Cloud | https://www.luminarycloud.com/careers | CFD / Cloud HPC |
| Near Space Labs | https://nearspacelabs.com/careers | Space (board confirmed, no interns) |
...
Open Claude Code in this repo directory and paste the following prompt. The efficient approach uses Bash to curl Greenhouse/Lever APIs directly (zero LLM tokens for API scraping), then a single agent for web searches.

```
Search for open aerospace and defense internships for Summer 2027 and Spring 2027.

**Filters — apply to every role:**
- US-based only: exclude any role where the primary work location is outside the United States. For Palantir "France" / "Poland" cohorts, exclude even if the listed city is US-based, since the deployment is abroad.
- Technical roles only: include software engineering, hardware engineering, electrical engineering, mechanical engineering, GNC, avionics, propulsion, flight test, systems engineering, embedded systems, autonomy, aerodynamics, simulation, CFD, FEA, manufacturing engineering, perception, robotics, FPGA, forward deployed software engineer. Exclude: business development, operations, people ops, accounting, marketing, communications, supply chain, finance, HR, legal, procurement, construction management, field marketing, community engagement.

**Step 1 — Bash API scrape (run in terminal, no LLM needed):**

```bash
SCRATCHPAD="/tmp/intern_scrape"
mkdir -p "$SCRATCHPAD"

GH_SLUGS=(spacex rocketlab relativityspace stokespace firefly ablspacesystems
  vast vastspa jobyaviation archeraviation wiskaero betatechnologies supernal
  andurilindustries shieldai kratosd leidos saic hermeus ursamajor
  firehawkaerospace venusaerospace sarcos xwing flyzipline trueanomalyinc
  physicsxai nearspacelabs luminarycloud dedrone fortemtechnologies
  aerojetrocketdyne apexspace vardaspace starfishspace turionspace)
...
LEVER_SLUGS=(palantir hermeus anduril shieldai skydio jobyaviation archeraviation
  stokespace relativity dedrone fortem kratos betatechnologies supernal ursamajor
  venusaero firehawk sarcos xwing zipline trueanomaly apexspace vardaspace
  starfishspace turionspace wiskaero)
...
- Search for 2027 intern roles at companies not found in Step 1 (Anduril, Shield AI, Skydio, Joby, Archer, Wisk, Beta, companies in Manual Check section)
- Search Greenhouse/Lever for Bucket B startups: `site:greenhouse.io "summer 2027" intern aerospace`, `site:lever.co "summer 2027" intern defense`
