...
| Booz Allen Hamilton 🔥 🎯 | University - 2027 Summer Games Software Developer Intern | McLean, VA (8 locations) | 🇺🇸 | 2026-09-15 | [Apply](https://bah.wd1.myworkdayjobs.com/BAH_Jobs/job/McLean-VA/University--2027-Summer-Games-Software-Developer-Intern_R0248029) |
...
> **2026-09-22 targeted sweep results**: **major find — Booz Allen Hamilton's Workday tenant was misconfigured in the tracker/scanner all along** (`boozallen.wd1` doesn't exist; the real tenant is `bah.wd1`), which is why every prior check reported "unavailable" — it was a wrong-URL 404, not a real outage. Found and added a live "University - 2027 Summer Games" internship program with Systems Engineer Intern (11 locations) and Software Developer Intern (8 locations) reqs, posted 2026-09-04/09-15 — representative rows added to the Summer 2027 table, scanner config fixed. Also found and added L3Harris's **Intern, Software Engineer (Spring 2027)** (Greenville, TX, explicit term, confirmed live). Checked with no new in-scope findings: RTX, Lockheed Martin, Honeywell, Nvidia, Hermeus, Palantir, Shield AI, Anduril — all current GNC/SWE/systems-eng-relevant postings at these companies are already tracked. Several RTX/Lockheed/L3Harris leads from web search (Lockheed's Dallas GNC Intern, RTX's Orbital Mechanics/Space GNC Intern and Richardson TX SWE Intern) confirmed **dead/404** on direct fetch — stale search cache, not added.
...
| Booz Allen Hamilton 🔥 🎯 | [bah.wd1.myworkdayjobs.com/BAH_Jobs](https://bah.wd1.myworkdayjobs.com/BAH_Jobs) | Workday — **tenant was wrong in the tracker/scanner** (`boozallen.wd1` doesn't exist; correct tenant is `bah.wd1`, fixed 2026-09-22) | **2026-09-22**: the "Workday unavailable" outage on every prior check was a wrong-tenant 404, not a real outage. Correct tenant found via direct browser: live "University - 2027 Summer Games" internship program with Systems Engineer Intern (11 locations) and Software Developer Intern (8 locations) reqs, posted 2026-09-04/09-15 — added representative rows to the Summer 2027 Primes & OEMs table above. Also has Data Scientist and Cyber Security Intern tracks in the same program (not 🎯, not added). `scripts/intern_scan.mjs` updated to scan `bah.wd1` going forward |
